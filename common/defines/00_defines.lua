...
NGame = {
	...
	SAVE_VERSION = 30,								-- 1.15.0 (unnamed)
	...
	ENERGY_RESOURCE = "fossil_fuels",						-- resource that will give country energy 
...
NGeography = {
	MEDITERRANEAN_SEA_REGIONS = { 29 }, -- The sea regions that are considered as part of the Mediterranean sea
},
...
NDiplomacy = {
	...
	TENSION_PEACE_FACTOR = 0,					-- scale of the amount of tension (from war declaration) reduced when peace is completed. Scaled by current world threat * TENSION_PEACE_FACTOR_THREAT_FACTOR
...
NAI = {
	...
	CANCEL_COMBAT_MIN_DURATION_HOURS = 96,              -- Only allow cancelling (normal) combat if at least <value> hours have passed
